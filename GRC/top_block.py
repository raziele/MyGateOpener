...
# Title: Top Block
# Generated: Sat Jun 11 15:02:32 2016
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.blocks_wavfile_sink_0_0 = blocks.wavfile_sink("/home/maayan4/MyGateOpener/MyGarbage/baseband_mm.wav", 1, samp_rate/8, 8)
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink("/home/maayan4/MyGateOpener/MyGarbage/baseband.wav", 1, samp_rate*gain_coeff/decimation_coeff, 8)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_vff((100, ))
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, "/home/maayan4/MyGateOpener/MyGarbage/trimmed.cfile", False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, "/home/maayan4/MyGateOpener/MyGarbage/parkRC_bytes", False)
